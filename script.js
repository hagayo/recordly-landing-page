(function () {
  ...
  const translations = {
    he: {
      ...
      proof_text: "רקורדלי נבנתה לעבודה מקומית. ההקלטה והעריכה לא צריכות את הענן שלנו, ולכן תוכן הסרטונים שלך לא נשלח אלינו.",
      ...
      legal_updated: "עודכן לאחרונה: מאי 2026",
      ...
      contact_response_note: "אנחנו מתחייבים להגיב במהירות האפשרית לכל פנייה",
      contact_name: "שם מלא",
      ...
      download_info_1_title: "מה מקבלים אחרי הורדה?",
      download_info_1_text: "אפליקציה להקלטת מסך, מצלמה, מיקרופון וסאונד מערכת. המטרה היא ליצור סרטוני הדרכה בוידיאו בקלות ובמהירות. כדי להשתמש בהם מיד.",
      download_info_2_title: "מה ההבדל בין חינם לפרו?",
      download_info_2_text: "חינם נותן לך להתחיל ישר עם כל הפונקציונאליות, עד 5 הקלטות בחודש. פרו נועד לאנשים שמעבירים הרבה הדרכות וצריכים כמות חודשית גדולה יותר.",
      download_info_3_title: "הערה חשובה",
      download_info_3_text: "רקורדלי נמצא כרגע בגרסת בטא מתקדמת. ווינדוס עלול להראות אזהרה לגבי האפליקציה, כי הקוד עדיין לא חתום תחת מייקרוסופט.",
      ...
      guide_red_flags_label: "דגלים אדומים",
      guide_red_flags_title: "מתי צריך לחשוב פעמיים לפני בחירת מקליט מסך?",
      guide_red_flag_1: "כשהכלי דורש העלאה לענן של תוכן פרטי, גם כשאין צורך בעריכה או בפעלות בענן.",
      guide_red_flag_2: "כשעריכת הסרטון דורשת לימוד ארוך של שימוש בתוכנה או ידע של עורך וידאו מקצועי",
      guide_red_flag_3: "כשהתוכנית החינמית חסרה בפיצ'רים או פונקציונאליות כדי לבדוק שימוש אמיתי",
      guide_red_flag_4: "כאשר ייצוא או שיתוף של הסרטונים מגביל אותך לפלטפורמה אחת. עם רקורדלי הקבצים תמיד שלך ואצלך!",
      ...
      pricing_pro_cta: "שדרוג לפרו",
      pricing_pro_feature_1: "כל מה שיש בחינם",
      ...
      pricing_col_free: "חינם",
      pricing_col_pro: "פרו",
      pricing_cmp_same_app: "אותה אפליקציית רקורדלי",
      pricing_cmp_local: "הקלטה מקומית",
      ...
      pricing_story_label: "מתי כדאי פרו?",
      pricing_story_title: "כשהקלטת סרטונים או הדרכות היא חלק מהעבודה שלך, ואתה לא רוצה הגבלות.",
      pricing_story_text_1: "גרסת החינם מעולה לבדיקה והתנסות עם רקורדלי. כשאתה מוצא את עצמך מקליט פעם ביום או יומיים סרטון לעוקבים אחריך, זה כנראה הזמן לשדרג.",
      pricing_story_text_2: "בשביל מחיר חודשי פעוט, רקורדלי היא כלי עבודה אמיתי, שמאפשר לך להקליט ולערוך בקלות הדרכות לעוקבים שלך.",
      ...
      pricing_faq_5_q: "האם פרו מתאים לי אם אני מקליט רק פעם בשבוע?",
      pricing_faq_5_a: "כנראה שגרסת החינם מספיקה עבורך. פרו נועד לאנשים ומורים שהקלטת תוכן, עריכה, או תמיכה בוידיאו, הם חלק מהיומיום שלהם.",
      pricing_faq_6_q: "האם מקבלים פיצ'רים נוספים בגרסת פרו?",
      pricing_faq_6_a: "לא! רקורדלי תמיד שומרת על עקרון השיוויון. גרסת פרו רק פותחת אפשרות ליותר הקלטות ויותר זמן.",
      pricing_faq_7_q: "למה לא להשתמש בכלי חינמי אחר?",
      pricing_faq_7_a: "אם כלי אחר נותן לך את הפונקציונאליות והפרטיות שאתה צריך, מעולה. רקורדלי מאזנת בין קלות השימוש לבין יכולות מקצועיות ושמירה מוחלטת על פרטיות המשתמשים.",
      definition_label: "מה זה רקורדלי?",
      definition_title: "אפליקציה קלה להקלטת מסך עבור לימוד על המחשב ועל תוכנות למורים ומדריכים.",
      definition_text_1: "רקורדלי היא אפליקציית דסקטופ שעוזרת למורים, יוצרי תוכן, גיימרים, ומפתחים, להקליט את המסך שלהם עם המצלמה והמיקרופון כדי להראות כיצד הם מבצעים פעולות על המחשב שלהם.",
      definition_text_2: "במקום להפוך כל סרטון לפרוייקט כבד בענן, רקורדלי מתרכזת במה שיוצרים באמת צריכים: קל, פשוט, פרטי ומקומי, עם יכולת לייצא או לשתף את הקבצים מייד, בלי סימן מים או הגבלה.",
      workflow_label: "תהליך",
      workflow_title: "נבנה עבור יצירת הדרכות בקלות, ללא כאב ראש",
      workflow_text: "רקורדלי שומרת על תהליך פשוט: להקליט את התוכן שלך, ואז לערוך כל ערוץ בנפרד ישר במקום וללא הגבלה. בלי אלפי אפשרויות ותפריטים, רק מה שצריך. יותר זמן להתעסק בתוכן שלך באמת.",
      workflow_step_1: "לבחור מצלמה, מיקרופון, עם\בלי קול מערכת, ולהקליט",
      workflow_step_2: "להקליט את התוכן שלך גם כשאין אינטרנט או קליטה",
      workflow_step_3: "חיתוך שתיקות ועריכה, לפני שיתוף או ייצוא",
      workflow_step_4: "להוציא סרטון מקצועי לתלמידים, לקוחות, או קהילת העוקבים שלך.",
      local_deep_label: "למה הקלטה מקומית ופרטית זה חשוב?",
      local_deep_title: "למה כל הקלטה צריכה להתחיל בענן? ומה קורה כשאין רשת?",
      local_deep_text_1: "הרבה מקליטי מסך בנויים סביב העלאה של התוכן לענן. זה יכול להיות שימושי עבור גיבוי, אבל חושף את התוכן שלך לעוד סיכון אבטחה או גניבה של תוכן קנייני.",
      local_deep_text_2: "רקורדלי פועלת מקומית בלבד על המחשב שלך. שום תוכן לא יוצא מהמחשב שלך לרשת.אתה מחליט אילו קבצים לשתף דרכנו או דרך הרשתות החברתיות. זה הרבה יותר פשוט, קל ובטוח.",
      usecases_label: "שימושים פופולריים",
      usecases_title: "רקורדלי נועדה לכל מי שמסביר משהו על המסך.",
      usecase_teachers_title: "מורים, מרצים, גיימרים, ויוצרי תוכן.",
      usecase_teachers_text: "לצלם שיעורים קצרים, תוכן לקורסים, משחק בזמן אמת, או יצירה על המחשב בתוך שניות.",
      usecase_devs_title: "מפתחים וצוותי מוצר",
      usecase_devs_text: "לייצר סרטונים שמראים באגים בזמן אמת, עבור שיתוף עם צוותי תמיכה או טיפול בתקלות. לייצר סרטוני דמו לגרסאות מוצר חדשות, הסבר תהליכים, סקירת פיצ'רים, ועוד עם הדרכה שלך שמסבירה בדיוק את מה שקורה על המסך.",
      usecase_marketers_title: "יוצרים, משווקים, ובעלי עסקים קטנים",
      usecase_marketers_text: "להפיק סרטוני מוצר, או סרטונים לעסק ולקידום, כדי לשפר נראות חשיפה ומכירות, בלי להאבק בכלים ליצירת וידיאו.",
      usecase_ai_title: "מחנכים ומורים אונליין",
      usecase_ai_text: "להראות איך כותבים פרומפטים, משתמשים בכלי בינה מלאכותית, או תהליכים שמשלבים מספר תוכנות, כדי שהקהל שלך יבין בקלות."
    },
    en: {
      ...
      contact_response_note: "We promise to deal with requests as fast as possible.",
